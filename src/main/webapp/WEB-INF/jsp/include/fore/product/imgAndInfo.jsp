...
$(function(){
    ...
    $("button .loginSubmitButton").click(function () {
        ...
        var page= "${pageContext.request.contextPath}/ajaxLogin";
        var data = {
        		'name':name, 
        		'password':password
        };
	...
	<div class="infoInimgAndInfo">
		...
		<div class="productNumber">
			<span>数量</span> <span> <span class="productNumberSettingSpan">
					<input class="productNumberSetting" name="number" type="text"
					value="1">
		...
		<div class="buyDiv">
			<a class="buyLink buyButton" href="forebuyone/${p.id}">
				<button class="buyButton">立即购买</button>
			</a> 
			<a href="#nowhere" class="addCartLink">
					<button class="addCartButton buyButton">
